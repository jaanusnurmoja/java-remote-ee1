...
@RestController
@RequestMapping("/api/java-remote-ee-1-kafka")
public class JavaRemoteEe1KafkaResource {
    private final Logger log = LoggerFactory.getLogger(JavaRemoteEe1KafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JavaRemoteEe1KafkaResource(KafkaProperties kafkaProperties) {
